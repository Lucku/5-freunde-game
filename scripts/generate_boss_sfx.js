...
const SOUNDS = [
    ...
    // ── Disciples of Deception — Psycho (Teal) ─────────────────────────────────
    {
        id: 'attack_psycho',
        boss: 'psycho',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'attack_psycho.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Sharp psychic crackle, slightly unhinged glassy pitch with a quick warble, high-frequency synaptic snap',
    },
    {
        id: 'melee_psycho',
        boss: 'psycho',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'melee_psycho.wav',
        duration: 0.6,
        promptInfluence: 0.4,
        description: 'Wild distorted melee thud with brief reverberant echo and erratic pitch flicker, slightly manic close-range hit',
    },
    {
        id: 'dash_psycho',
        boss: 'psycho',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'dash_psycho.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Glitchy zap with pitch-shifting tail, fast electrical stutter as something dashes through a tear in space',
    },
    {
        id: 'special_psycho',
        boss: 'psycho',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'special_psycho.wav',
        duration: 1.5,
        promptInfluence: 0.4,
        description: 'Shimmering psychic resonance with multiple layered tones, chain reaction of mind-cracking pings bouncing between targets, mid-frequency mental fracture',
    },
    {
        id: 'hysteria_activate',
        boss: 'psycho',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'hysteria_activate.wav',
        duration: 1.0,
        promptInfluence: 0.45,
        description: 'High-pitched mental snap building into a wild reverberating tail, the audible feeling of a mind cracking open with frenzied energy release',
    },

    // ── Disciples of Deception — Mirror (Marine Blue) ──────────────────────────
    {
        id: 'attack_mirror',
        boss: 'mirror',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'attack_mirror.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Crystalline chime with sharp trailing ring, faceted glass shard cutting through air with prismatic high-frequency sparkle',
    },
    {
        id: 'melee_mirror',
        boss: 'mirror',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'melee_mirror.wav',
        duration: 0.7,
        promptInfluence: 0.4,
        description: 'Heavy glass crack and deep impact, thick mirror shattering on contact with low-frequency thud beneath crystalline shards',
    },
    {
        id: 'dash_mirror',
        boss: 'mirror',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'dash_mirror.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Smooth fast glide with shimmering crystalline tail, the sound of polished glass slicing through air',
    },
    {
        id: 'special_mirror',
        boss: 'mirror',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'special_mirror.wav',
        duration: 1.4,
        promptInfluence: 0.4,
        description: 'Shattering glass burst with multi-hit cascading fragments, prismatic glass exploding outward in a star pattern with bright high-frequency tinkle',
    },
    {
        id: 'shield_activate',
        boss: 'mirror',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'shield_activate.wav',
        duration: 0.9,
        promptInfluence: 0.45,
        description: 'Clean resonant ping with a rising tone, hexagonal mirror barrier snapping into place with a confident metallic chime',
    },
    {
        id: 'shield_reflect',
        boss: 'mirror',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'shield_reflect.wav',
        duration: 0.5,
        promptInfluence: 0.45,
        description: 'Sharp deflection chime, projectile bouncing off polished glass with a clean ping and slightly reversed reverb tail',
    },

    // ── Disciples of Deception — Smoke (Slate Gray) ────────────────────────────
    {
        id: 'attack_smoke',
        boss: 'smoke',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'attack_smoke.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Soft compressed air release with a muffled mid-frequency impact, the hiss of pressurized smoke escaping with a quiet thud',
    },
    {
        id: 'melee_smoke',
        boss: 'smoke',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'melee_smoke.wav',
        duration: 0.7,
        promptInfluence: 0.4,
        description: 'Heavy whoosh with a dull thud, a thick fog-shrouded melee impact, low-frequency dampened hit',
    },
    {
        id: 'dash_smoke',
        boss: 'smoke',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'dash_smoke.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Fast exhaled hiss, short sharp release of compressed smoke as something disappears into vapor',
    },
    {
        id: 'special_smoke',
        boss: 'smoke',
        dir: 'dlc/disciples_of_deception/audio/sounds',
        filename: 'special_smoke.wav',
        duration: 1.6,
        promptInfluence: 0.4,
        description: 'Deep pressurized burst expanding outward, room-tone smoke explosion with low rumble and lingering hiss as the area fills with thick dark fog',
    },

    // ── Radiance of Ruin — Light (Radiant Gold) ────────────────────────────────
    {
        id: 'attack_light',
        boss: 'light',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'attack_light.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Bright sun-mote chime with soft homing whir, small gilded projectile launch with high-frequency shimmer and a faint comet whoosh tail',
    },
    {
        id: 'melee_light',
        boss: 'light',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'melee_light.wav',
        duration: 0.6,
        promptInfluence: 0.4,
        description: 'Pierce-beam impact with metallic resonance, thin gold lance striking through the air with a clean ringing hitscan slice and a brief metallic afterglow tail',
    },
    {
        id: 'dash_light',
        boss: 'light',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'dash_light.wav',
        duration: 0.4,
        promptInfluence: 0.4,
        description: 'Quick light whoosh with chime tail, a fast warm gold burst of motion ending in a bright crystalline ping',
    },
    {
        id: 'special_light',
        boss: 'light',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'special_light.wav',
        duration: 1.4,
        promptInfluence: 0.45,
        description: 'Expanding solar bloom with a sustained warm hum, a reverent gold-white sphere blooming outward with layered harmonic ringing and a soft sacred drone',
    },
    {
        id: 'unveiling_activate',
        boss: 'light',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'unveiling_activate.wav',
        duration: 2.0,
        promptInfluence: 0.5,
        description: 'Long ascending bell tone fading into a white-light wash, a sacred mask lifting with massive sustained harmonics building to a brilliant blinding crescendo and a final shimmering tail',
    },
    {
        id: 'civilian_collapse',
        boss: 'light',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'civilian_collapse.wav',
        duration: 0.8,
        promptInfluence: 0.45,
        description: 'Glass-crack rattle with a sudden drop in pitch, the audible sound of a ceramic mask fracturing and falling into a dull grey hush, sacred shimmer collapsing into silence',
    },

    // ── Radiance of Ruin — Thorn (Crimson) ─────────────────────────────────────
    {
        id: 'attack_thorn',
        boss: 'thorn',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'attack_thorn.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Wet thorn-snap with organic whoosh, a sharp vegetal release of a barbed projectile cutting through air with a faint blood-mist trail',
    },
    {
        id: 'melee_thorn',
        boss: 'thorn',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'melee_thorn.wav',
        duration: 0.6,
        promptInfluence: 0.4,
        description: 'Whip-crack with a heavy flesh-thud tail, a thorned vine lashing through air ending in a meaty wet impact',
    },
    {
        id: 'dash_thorn',
        boss: 'thorn',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'dash_thorn.wav',
        duration: 0.4,
        promptInfluence: 0.4,
        description: 'Rustling vines with a brief sharp snap, fast vegetal motion as living foliage parts and recloses',
    },
    {
        id: 'special_thorn',
        boss: 'thorn',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'special_thorn.wav',
        duration: 1.6,
        promptInfluence: 0.45,
        description: 'Heavy bloom-burst with a pulsing low rumble, a giant red rose erupting from the ground with a wet organic swell and a deep heart-like thrum',
    },
    {
        id: 'reckoning_activate',
        boss: 'thorn',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'reckoning_activate.wav',
        duration: 2.0,
        promptInfluence: 0.5,
        description: 'Deep ground-rip transitioning into a sustained crimson roar, massive thorn vines erupting through the arena floor with a low primal scream and a layered visceral organic crescendo',
    },
    {
        id: 'lifebloom_heal',
        boss: 'thorn',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'lifebloom_heal.wav',
        duration: 0.6,
        promptInfluence: 0.45,
        description: 'Soft wet-leaf chime with a rising tone, a gentle vegetal healing pulse with a warm organic shimmer fading into stillness',
    },

    // ── Radiance of Ruin — Dream (Twilight Indigo) ─────────────────────────────
    {
        id: 'attack_dream',
        boss: 'dream',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'attack_dream.wav',
        duration: 0.5,
        promptInfluence: 0.4,
        description: 'Soft synth whisper with a curving pitch, a thin violet dreamspace arc moving through air with faint dotted-trail resonance and a dreamy reverb tail',
    },
    {
        id: 'melee_dream',
        boss: 'dream',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'melee_dream.wav',
        duration: 0.6,
        promptInfluence: 0.4,
        description: 'Glass-on-velvet slash with a faint chime, a pale-violet blade gliding through soft fabric with a brief glittery sparkle at the apex',
    },
    {
        id: 'dash_dream',
        boss: 'dream',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'dash_dream.wav',
        duration: 0.4,
        promptInfluence: 0.4,
        description: 'Phase-shimmer with subtle reverb, a quick translucent dissolve and re-form motion sound with breathy synth swell',
    },
    {
        id: 'special_dream',
        boss: 'dream',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'special_dream.wav',
        duration: 1.5,
        promptInfluence: 0.45,
        description: 'Deep bell layered with a swelling pad and dreamy reverb, a purple dreamspace pocket opening with rotating galaxy harmonics and slow shimmering tones',
    },
    {
        id: 'long_sleep_activate',
        boss: 'dream',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'long_sleep_activate.wav',
        duration: 2.5,
        promptInfluence: 0.5,
        description: 'Slow descending lullaby drone with wide stereo, a vast indigo dreamspace settling over the arena with distant star-twinkle harmonics and a deep sustained pad fading into hushed reverb',
    },
    {
        id: 'lucid_step_phase',
        boss: 'dream',
        dir: 'dlc/radiance_of_ruin/audio/sounds',
        filename: 'lucid_step_phase.wav',
        duration: 0.7,
        promptInfluence: 0.45,
        description: 'Quick reverse-swell with a breath-in tone, the audible feeling of phasing into dreamspace, soft suction and a brief shimmering void inhale',
    },
];
