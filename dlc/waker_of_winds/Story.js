...
window.WIND_STORY_CHAPTERS = [
    // --- ARC 1: THE WHISPER OF THE WIND (Weeks 1-10) ---
    {
        ...
        data: { biome: 'HERO', trial: { type: 'FLOW', params: { threshold: 50 } } }
    },
    {
    ...
    },
    {
        ...
        data: { biome: 'HERO', bossId: 'CLOUD_GOLEM' }
    },
    {
    ...
    },
    {
        ...
        data: { biome: 'HERO', bossId: 'STORM_CROW' }
    },
    ...
    // --- ARC 2: THE GATHERING STORM ---
    {
        ...
        data: { biome: 'HERO', chaosMode: 'SPEED_DEMON', trial: { type: 'SPEED', params: { time: 60 } } }
    },
    {
    ...
    },
    {
        ...
        data: { biome: 'HERO', trial: { type: 'SPEED', params: { time: 45 } } }
    },
    {
    ...
    },
    {
        ...
        data: { biome: 'metal', trial: { type: 'SPEED', params: { time: 50 } } }
    },
    {
        ...
        data: { biome: 'HERO', bossId: 'TORNADO_MACHINA' }
    },
    {
    ...
    },
    {
        ...
        data: { biome: 'HERO', trial: { type: 'FLOW', params: { threshold: 80 } } }
    },
    {
        ...
        data: { biome: 'HERO', trial: { type: 'LEVEL_REACH', params: { level: 40 } } }
    },
    {
    ...
    { id: "wind_30", wave: 30, hero: "AIR", type: "BOSS_FIGHT", title: "Doppelganger", text: "Defeat your shadow. Prove you are the true Air Hero.", data: { biome: 'HERO', bossId: 'AIR_CLONE' } },

    // Arc 4
    { id: "wind_31", wave: 31, hero: "AIR", type: "NARRATIVE", title: "Self Mastery", text: "You have conquered yourself. Now, become lighter than air.", data: { biome: 'HERO', trial: { type: 'FLOW', params: { threshold: 50 } } } },
    { id: "wind_32", wave: 32, hero: "AIR", type: "COMPANION_JOIN", title: "An Old Ally", text: "The Fire Hero sends aid. Fire joins Wind.", data: { biome: 'fire', companionType: "fire" } },
    ...
    { id: "wind_34", wave: 34, hero: "AIR", type: "OBJECTIVE_WAVE", title: "Peak Condition", text: "The Storm King wakes. You must become stronger to face him.", data: { biome: 'HERO', trial: { type: 'LEVEL_REACH', params: { level: 50 } } } },
    { id: "wind_35", wave: 35, hero: "AIR", type: "NARRATIVE", title: "The Warning", text: "The palace shakes. The King demands perfection.", data: { biome: 'HERO', trial: { type: 'NO_HIT', params: { hits: 2 } } } },
    { id: "wind_36", wave: 36, hero: "AIR", type: "NARRATIVE", title: "Hurricane", text: "Debris fills the air. Flow around it.", data: { biome: 'HERO', trial: { type: 'FLOW', params: { threshold: 90 } } } },
    { id: "wind_37", wave: 37, hero: "AIR", type: "WAVE_OVERRIDE", title: "Debris Field", text: "Giant rocks are thrown by the storm. Dodge them.", data: { biome: 'HERO', chaosMode: 'GIANT_ENEMIES', trial: { type: 'NO_HIT', params: { hits: 4 } } } },
    { id: "wind_38", wave: 38, hero: "AIR", type: "NARRATIVE", title: "The Throne", text: "A cold wind blows from the throne. Rush forward.", data: { biome: 'ice', trial: { type: 'SPEED', params: { time: 40 } } } },
    { id: "wind_39", wave: 39, hero: "AIR", type: "NARRATIVE", title: "Face to Face", text: "He looks tired, but powerful. Keep moving.", data: { biome: 'HERO', trial: { type: 'FLOW', params: { threshold: 20 } } } },
    { id: "wind_40", wave: 40, hero: "AIR", type: "BOSS_FIGHT", title: "The Lieutenant", text: "The Living Tornado guards his master. Disperse it.", data: { biome: 'HERO', bossId: 'TORNADO_MACHINA' } },

    // Arc 5
    { id: "wind_41", wave: 41, hero: "AIR", type: "NARRATIVE", title: "The Truth", text: "The King was once a hero like you. He tests you now.", data: { biome: 'HERO', trial: { type: 'SPEED', params: { time: 60 } } } },
    { id: "wind_42", wave: 42, hero: "AIR", type: "NARRATIVE", title: "Inheritance", text: "To take his place, you must be untouchable.", data: { biome: 'HERO', trial: { type: 'NO_HIT', params: { hits: 2 } } } },
    { id: "wind_43", wave: 43, hero: "AIR", type: "OBJECTIVE_WAVE", title: "Final Gate", text: "Prove complete mastery. Become stronger.", data: { biome: 'HERO', trial: { type: 'LEVEL_REACH', params: { level: 60 } } } },
    ...
    { id: "wind_46", wave: 46, hero: "AIR", type: "NARRATIVE", title: "Eye of the Needle", text: "Thread the needle. One path forward.", data: { biome: 'HERO', trial: { type: 'SPEED', params: { time: 50 } } } },
