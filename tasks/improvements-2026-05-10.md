...
- [x] 26. Particle batching. Sort by color/size; batch fills. *(P7: covered by sprite cache. Per-particle `fillStyle` thrash + `arc` path build are eliminated; explicit alpha-bucket batching adds little after sprite cache and is deferred.)*
